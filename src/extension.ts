...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
    try {
        ...
        context.subscriptions.push(
            ...
            vscode.commands.registerCommand("lovecode.previewProblem", (node: LeetCodeNode) => show.previewProblem(node)),
            vscode.commands.registerCommand("lovecode.showProblem", (node: LeetCodeNode) => show.showProblem(node)),
